...
- Raised the global coverage regression floors to 94% statements, 89% branches, 94% functions, and 95% lines; after adding the full tool matrix, Inspector/Conformance runner boundaries, bounded secret-scanner regressions, the T7-T10 evaluation suites, and self-hosted reviewer feedback regressions, the current 1453-test baseline is 96.63% statements, 91.51% branches, 97.42% functions, and 97.35% lines.
