...
- Raised the global coverage regression floors to 94% statements, 89% branches, 94% functions, and 95% lines; after adding the full tool matrix, Inspector/Conformance runner boundaries, bounded secret-scanner regressions, and the T7/T8 evaluation suites, the current 1339-test baseline is 96.46% statements, 91.26% branches, 97.17% functions, and 97.22% lines.
