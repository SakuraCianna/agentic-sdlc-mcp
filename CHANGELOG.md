...
- Raised the global coverage regression floors to 94% statements, 89% branches, 94% functions, and 95% lines; after adding the full tool matrix, Inspector/Conformance runner boundaries, bounded secret-scanner regressions, the T7-T10 evaluation suites, and self-hosted reviewer feedback regressions, the current 1475-test baseline is 96.64% statements, 91.55% branches, 97.43% functions, and 97.35% lines.
