...
`npm run test:coverage` 当前执行全局最低门槛：statements 94%、branches 89%、functions 94%、lines 95%，并输出 text、LCOV 与 `coverage/coverage-summary.json`。T1 收尾基线为 1062 个测试、95.15% statements / 90.85% branches / 95.37% functions / 95.98% lines；门槛刻意保留 Node 22/24 插桩余量。
